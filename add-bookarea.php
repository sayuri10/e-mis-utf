...
//เลือกประเภท
		...
		//ส่งชื่อหนังสือลง database	
			...
			values( '' , '$frm_priority' , '$frm_doc_num' , '$frm_title' , '$date_doc_send' , '$frm_from' , '$fromgroup_typeid' , '2' , '$frm_detail' , '$today_date' , '$arrdate[2]' , '$book_send_num' , '' , 'file1' , 'file2' , 'file3' , 'file4' , 'file5' , '1' )";
...
include("makename.php");
	...
	window.location='sendbookarea.php';
	</script>";
