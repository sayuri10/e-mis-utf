...
echo"<FRAME SRC='adminmenu.php' NAME='leftframe' SCROLLING='NO' NORESIZE class='lefttext'>";
echo"<FRAME SRC='body.php' NAME='rightframe' SCROLLING='YES' NORESIZE id='rightframe'>";
echo"</FRAMESET>";
echo"</FRAMESET>";
echo"<NOFRAMES>";
}
